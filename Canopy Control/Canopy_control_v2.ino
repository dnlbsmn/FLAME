...
long counter2 = 0;
long counter3 = 0;
long drift_correct1 = 0;
long drift_correct2 = 0;
...
void loop() {
  ...
  if (Serial.available()){
    ...
    if (X1_tick != X1_prev & X1_tick == 1){
      ...
      drift_correct1 = 48-counter1;
      counter1 = 0;
      counter2 = 0; //drift_correct2 - drift_correct1;
    }
    ...
    else target_frequency2 = val2 * (1+ ((3*P_CORRECTION/48) * (counter1-(counter2*(val1/val2)))));
